...
struct MinisApp: App {
    ...
    private static let fileProviderDomain = NSFileProviderDomain(
        identifier: NSFileProviderDomainIdentifier("com.r0gueee.multiminis.files"),
        displayName: "Minis"
    )
    ...
    private static func migrateSharedDirToAppGroup() {
        ...
        let container = fm.containerURL(forSecurityApplicationGroupIdentifier: "group.com.r0gueee.multiminis")!
    ...
    private static func logFPSyncTracePaths() {
        let fm = FileManager.default
        let groupID = "group.com.r0gueee.multiminis"
