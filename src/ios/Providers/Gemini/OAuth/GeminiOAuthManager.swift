...
final class GeminiOAuthManager: NSObject, ObservableObject {
    ...
    static let legacyKeychainService = "com.r0gueee.multiminis.gemini-oauth"
    static let legacyKeychainAccount = "token"
    static let legacyEmailKey = "com.r0gueee.multiminis.gemini-email"
    static let legacyProjectIDKey = "com.r0gueee.multiminis.gemini-gcp-project"
