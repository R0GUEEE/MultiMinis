...
enum ProviderMigration {
    ...
    private static let migrationKey = "com.r0gueee.multiminis.provider-migration-v1-done"
    private static let oauthMigrationKey = "com.r0gueee.multiminis.provider-migration-oauth-v2-done"
    ...
    private static func migrate(store: ProviderConfigStore) {
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.r0gueee.multiminis.anthropic-api-key") {
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.r0gueee.multiminis.gemini-api-key") {
            let instance = ProviderInstance(
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.r0gueee.multiminis.openai-api-key") {
            let instance = ProviderInstance(
    ...
    private static func loadLegacyAgentModelSettings() -> LegacyAgentModelSettings {
        let key = "com.r0gueee.multiminis.agent-model-settings"
    ...
    private static func isLegacyActiveProvider(_ rawValue: String) -> Bool {
        let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrService as String: "com.r0gueee.multiminis.active-provider",
