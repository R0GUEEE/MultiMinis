...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.r0gueee.multiminis.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.r0gueee.multiminis.files")
