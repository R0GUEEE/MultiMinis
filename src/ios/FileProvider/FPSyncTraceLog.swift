...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.r0gueee.multiminis.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.r0gueee.multiminis.FileProvider", category: "FPSyncTrace")
