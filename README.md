...
[![Platforms](https://img.shields.io/badge/Platforms-iOS-lightgrey.svg)](#beta-programme)

**A separate, on-device AI agent with a full Linux shell.**

MultiMinis is an independent app derived from OpenMinis. It brings leading
models — Claude, GPT, Gemini and more — into a native mobile experience, and
gives them a real computer to work with: a full Linux shell running on your
device, browser automation, extensible skills, persistent memory, and deep
system integration.

A distinguishing feature is the ability to **import and boot mini root
